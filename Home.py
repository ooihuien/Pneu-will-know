...
def show_home_page():
    home_img = Image.open("Pneu-will-know.png")
    ...
    # st.subheader("How to Diagnose Pneumonia?")
    ...
    with col1:
        ...
        * Sputum culture
        """)
    with col2:
        diagnosis_img = Image.open("pneumonia-diagnosis.png")
        st.image(diagnosis_img, use_column_width=True)

    # st.subheader("High Risk Group for Getting Pneumonia")
    ...
    * People who smoke
    ...
    st.text("")
    # st.subheader("Some Statistics about Pneumonia")
    ...
    3. In Malayisa, pneumonia is the second highest cause of death in 2019.
    """)

@st.cache
def load_image():
    img1 = Image.open("high risk grp 1.png")
    img2 = Image.open("high risk grp 2.png")
    img3 = Image.open("high risk grp 3.png")
    img4 = Image.open("high risk grp 4.png")
